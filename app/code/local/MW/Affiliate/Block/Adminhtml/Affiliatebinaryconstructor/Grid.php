<?php
class MW_Affiliate_Block_Adminhtml_Affiliatebinaryconstructor_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('affiliatebinary_constructor');
    ...
    {        
      	$collection = Mage::getModel('affiliate/affiliatebinaryconstructor')->getCollection();
    ...
    protected function _prepareColumns()
    {
    	...
    	$this->addColumn('profit', array(
        	'header'    => Mage::helper('affiliate')->__('Profit'),
          	'align'     => 'left',
                'filter'    => false,
                'renderer'  => 'affiliate/adminhtml_renderer_constructorreview',
          	'index'     => 'order',
      	));
        ...
        $this->addExportType('*/*/exportbinaryconstructorCsv', Mage::helper('affiliate')->__('CSV'));
        $this->addExportType('*/*/exportbinaryconstructorXml', Mage::helper('affiliate')->__('XML'));
...
//        $this->getCollection()->getSelect()->where("main_table.customer_id in (?)",$customer_ids);
    ...
    {
        return $this->getUrl('*/*/editconstructor', array('id' => $row->getId()));
    }
