<?php
class MW_Affiliate_Block_Adminhtml_Renderer_ResidualReport extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        if (sizeof($collection) > 0){
            $url = Mage::helper("adminhtml")->getUrl("affiliate/adminhtml_affiliatebinary/editresidual", array("id"=>$collection['id']));
