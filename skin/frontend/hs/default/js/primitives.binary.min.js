...
primitives.common.Connector.prototype.draw=function(a,b,c){var d,e,f,g,h,i,j,k,l,m=6*this.lineWidth,n,p,q=0,r=0,t,v=new primitives.common.PaletteItem({lineColor:this.color,lineWidth:this.lineWidth,lineType:this.lineType}),s=new primitives.common.PolylinesBuffer,w=s.getPolyline(v),a=(new primitives.common.Rect(a)).offset(this.offset),b=(new primitives.common.Rect(b)).offset(this.offset);i=[];switch(this.connectorShapeType){case 1:i=[-m/2,m/2];break;case 0:i=[0]}this.transform=new primitives.common.Transform;
...
this.panelSize.height,!1,this,function(a,b,c,d){t=new primitives.common.Size(c,d)});q=Math.max(this.hasLabel?n.width:0,5*m);if(a.right()+q<b.left()||a.left()>b.right()+q)if(a.left()>b.right()?(d=new primitives.common.Point(a.left(),a.verticalCenter()),e=new primitives.common.Point(b.right(),b.verticalCenter()),q=7,r=3):(d=new primitives.common.Point(a.right(),a.verticalCenter()),e=new primitives.common.Point(b.left(),b.verticalCenter()),q=3,r=7),f=new primitives.common.Rect(d,e),l=d.y<=e.y,k=d.x<
e.x,f.height<f.width){f.height<2*m&&f.offset(0,l?2*m:0,0,l?0:2*m);g=0;for(h=i.length;g<h;g+=1)j=i[g],s.addInverted(function(a){a=a.getPolyline(v);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+j));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),(l?f.top():f.bottom())+j,e.x,e.y+j))},!g),w.addArrow(this.lineWidth,function(a,b){var c=s.getPolyline(b);c.segments=c.segments.concat(a)});i=n.width<2*(f.width/5)?primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,
d.y,f.horizontalCenter(),l?f.top():f.bottom(),e.x,e.y,0.5):new primitives.common.Point(d.x,l?f.top():f.bottom());p=new primitives.common.Rect(i.x+(k?m:-n.width-m),l?i.y-n.height-m:i.y+m,n.width,n.height)}else{g=0;for(h=i.length;g<h;g+=1)j=i[g],s.addInverted(function(a){a=a.getPolyline(v);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+j));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+j*(l!=k?1:-1),(l?f.top():f.bottom())+j,f.horizontalCenter()+j*(l!=k?1:-1),
f.verticalCenter()+j));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+j*(l!=k?1:-1),(l?f.bottom():f.top())+j,e.x,e.y+j))},!g),w.addArrow(this.lineWidth,function(a,b){var c=s.getPolyline(b);c.segments=c.segments.concat(a)});p=new primitives.common.Rect(f.horizontalCenter()+(l!=k?m:-(m+n.width)),f.verticalCenter()-n.height/2,n.width,n.height)}else if(a.verticalCenter()<b.top()||a.verticalCenter()>b.bottom()){k=a.x<t.width/2;d=new primitives.common.Point(k?a.right():a.left(),
a.verticalCenter());e=new primitives.common.Point(k?b.right():b.left(),b.verticalCenter());r=q=k?3:7;f=new primitives.common.Rect(d,e);f.offset(10*m,0,10*m,0);l=d.y<=e.y;g=0;for(h=i.length;g<h;g+=1)j=i[g],s.addInverted(function(a){a=a.getPolyline(v);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+j));a.segments.push(new primitives.common.QuadraticArcSegment(k?f.right()+j*(l?-1:1):f.left()-j*(l?-1:1),f.verticalCenter(),k?b.right():b.left(),b.verticalCenter()-j))},!g),w.addArrow(this.lineWidth,
function(a,b){var c=s.getPolyline(b);c.segments=c.segments.concat(a)});i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,d.y,k?f.right():f.left(),f.verticalCenter(),e.x,e.y,0.5);p=new primitives.common.Rect(i.x+(k?m/2:-m/2-n.width),i.y-n.height/2,n.width,n.height)}else{d=new primitives.common.Point(a.horizontalCenter(),a.top());e=new primitives.common.Point(b.horizontalCenter(),b.top());r=q=1;f=new primitives.common.Rect(d,e);f.offset(0,7*m,0,0);k=d.x<e.x;g=0;for(h=i.length;g<h;g+=
1)j=i[g],s.addInverted(function(a){a=a.getPolyline(v);a.segments.push(new primitives.common.MoveSegment(d.x+j,d.y));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),f.top()-j*(k?-1:1),b.horizontalCenter()-j,b.top()))},!g),w.addArrow(this.lineWidth,function(a,b){var c=s.getPolyline(b);c.segments=c.segments.concat(a)});i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,d.y,f.horizontalCenter(),f.top(),e.x,e.y,0.5);p=new primitives.common.Rect(i.x-n.width/
2,i.y-(this.labelOffset+n.height),n.width,n.height)}s.transform(this.transform,!0);this.m_graphics.polylinesBuffer(s);if(this.hasLabel){switch(this.labelPlacementType){case primitives.common.ConnectorLabelPlacementType.From:p=this._getLabelPosition(a.x,a.y,a.width,a.height,p.width,p.height,this.labelOffset,q);break;case primitives.common.ConnectorLabelPlacementType.To:p=this._getLabelPosition(b.x,b.y,b.width,b.height,p.width,p.height,this.labelOffset,r)}this.transform.transformRect(p.x,p.y,p.width,
...
}0==c.segments.length&&(f=new primitives.common.MoveSegment(b.fromPoint),c.segments.push(f),h[a.segments.endSegmentKey]={point:f,isVertical:l});j=a.segments.segmentsHash.hasOwnProperty(b.oppositeKey)?new primitives.common.MoveSegment(b.toPoint.x+j,b.toPoint.y+k):new primitives.common.LineSegment(b.toPoint.x+j,b.toPoint.y+k);c.segments.push(j);0<d&&(l?f.y=j.y:f.x=j.x,null!=e&&(!a.segments.segmentsHash.hasOwnProperty(e.oppositeKey)&&a.segments.segmentsHash.hasOwnProperty(b.oppositeKey)?h.hasOwnProperty(b.oppositeKey)?
(k=h[b.oppositeKey],k.isVertical?f.y=k.point.y:f.x=k.point.x,g?k.point.y=f.y:k.point.x=f.x):h[b.oppositeKey]={point:f,isVertical:g}:a.segments.segmentsHash.hasOwnProperty(e.oppositeKey)&&!a.segments.segmentsHash.hasOwnProperty(b.oppositeKey)&&(h.hasOwnProperty(e.key)?(k=h[e.key],k.isVertical?f.y=k.point.y:f.x=k.point.x,g?k.point.y=f.y:k.point.x=f.x):h[e.key]={point:f,isVertical:l})),g=l,e=b);f=j});0<d&&!a.segments.segmentsHash.hasOwnProperty(e.oppositeKey)&&(b=h[e.key],b.isVertical?f.y=b.point.y:
f.x=b.point.x,g?b.point.y=f.y:b.point.x=f.x);c.transform(this.transform,!0);this.m_graphics.polyline(c.segments,c.paletteItem.toAttr())};
...
primitives.common.Polyline.prototype._getArrow=function(a,b,c,d,e,f){for(var g=[],h,i,e=[new primitives.common.Point(e,-f/2),new primitives.common.Point(0,0),new primitives.common.Point(e,f/2),new primitives.common.Point(3*(e/4),0)],j=Math.atan2(b-d,a-c),a=0,b=e.length;a<b;a+=1)f=e[a],h=f.x*Math.cos(j)-f.y*Math.sin(j),i=f.x*Math.sin(j)+f.y*Math.cos(j),f.x=h+c,f.y=i+d;g.push(new primitives.common.MoveSegment(e[0].x,e[0].y));g.push(new primitives.common.LineSegment(e[1].x,e[1].y));g.push(new primitives.common.LineSegment(e[2].x,
...
primitives.orgdiagram.BaseController.prototype._virtualUnbind=function(){this.m_placeholder.unbind("mousemove");this.m_placeholder.unbind("click");this.m_scrollPanel.unbind("keydown");"ontouchstart"in document.documentElement&&(this.m_scrollPanel[0].removeEventListener("gesturestart",this.onGestureStartHandler,!1),this.m_scrollPanel[0].removeEventListener("gesturechange",this.onGestureChangeHandler,!1));this.options.onDefaultTemplateRender=null;this.options.onCheckBoxTemplateRender=null;this.options.onGroupTitleTemplateRender=
null;this.options.onButtonsTemplateRender=null;this.options.onAnnotationLabelTemplateRender=null};primitives.orgdiagram.BaseController.prototype.update=function(a){switch(a){case 2:this._redrawHighlight();break;case 1:this._refresh();break;default:this._redraw()}};primitives.orgdiagram.BaseController.prototype._mouseCapture=function(a){this._dragStartPosition=new primitives.common.Point(this.m_scrollPanel.scrollLeft()+a.pageX,this.m_scrollPanel.scrollTop()+a.pageY);return!0};
...
primitives.orgdiagram.BaseController.prototype._tracePathAnnotations=function(){var a,b,c,d,e,f,g,h,i,j,k,l;a=0;for(b=this.options.annotations.length;a<b;a+=1)switch(c=this.options.annotations[a],c.annotationType){case 2:if(null==i&&(i=this._getConnectionsGraph()),null!=c.items&&0<c.items.length){k=c.items.slice(0);e=this._treeItemsByUserId[k[0]];if(1==k.length){c=0;for(d=e.logicalParents.length;c<d;c+=1)g=this._treeItems[e.logicalParents[c]],null!=g.itemConfig&&k.push(g.itemConfig.id)}if(1<k.length){c=
1;for(d=k.length;c<d;c+=1){g=this._treeItemsByUserId[k[c]];j=primitives.common.getShortestPath(i,e,g,function(a){return a.weight});e=1;for(f=j.length;e<f;e+=1)l=i[j[e-1]][j[e]],h=this._treeItems[l.id],h.highlightPath=1,l.hasOwnProperty("partnerid")&&(h=this._treeItems[l.partnerid],h.partnerHighlightPath=1);e=g}}}}};
primitives.orgdiagram.BaseController.prototype._getConnectionsGraph=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m={};b=0;for(c=this._treeLevels.length;b<c;b+=1){a=this._treeLevels[b];d=0;for(e=a.treeItems.length;d<e;d+=1){h=a.treeItems[d];h=this._treeItems[h];j=h.actualIsActive?100:1;h.connectorPlacement&8?k=[a.treeItems[h.levelPosition-1]]:h.connectorPlacement&2?k=[a.treeItems[h.levelPosition+1]]:h.connectorPlacement&1?(f=this._treeItems[h.visualParentId],k=1<f.partners.length?f.partners.slice(0):[h.visualParentId],
0<f.extraPartners.length&&(k=k.concat(f.extraPartners))):k=[];f=0;for(g=k.length;f<g;f+=1)l=k[f],i=this._treeItems[l],i=i.actualIsActive?100:1,m.hasOwnProperty(h.id)||(m[h.id]={}),m[h.id][l]=1==g?{id:h.id,weight:i}:{id:h.id,partnerid:l,weight:i},m.hasOwnProperty(l)||(m[l]={}),m[l][h.id]=1==g?{id:h.id,weight:j}:{id:h.id,partnerid:l,weight:j}}}return m};
...
primitives.orgdiagram.BaseController.prototype._drawAnnotations=function(){var a;a=8;var b,c,d,e,f,g,h,i,j,k,l,m;b=0;for(c=this.options.annotations.length;b<c;b+=1)switch(k=this.options.annotations[b],k.annotationType){case 0:if(null!=k.fromItem&&null!=k.toItem&&(e=this._treeItemsByUserId[k.fromItem],f=this._treeItemsByUserId[k.toItem],null!=e&&null!=f)){h=new primitives.orgdiagram.ConnectorAnnotationConfig;g=new primitives.common.Connector(this.graphics);g.orientationType=this.options.orientationType;
...
e;g.orientationType=this.options.orientationType;g.panelSize=a.size;g.labelTemplate=this._annotationLabelTemplate;g.labelTemplateHashCode=this._annotationLabelTemplateHashCode;g.hasLabel=null!=k.templateName||null!=k.label;l=new primitives.common.RenderEventArgs;l.context=k;l.templateName=g.labelTemplate;this.transform.transformRect(e.x,e.y,e.width,e.height,!0,this,function(a,b,c,d){a=new primitives.common.Rect(a,b,c,d);g.draw(a,l)})}}break;case 4:if(null!=k.items&&0<k.items.length){m||(m=this._getBackgroundManager());
g=new primitives.common.Perimeter(this.graphics);g.transform=this.transform;h=new primitives.orgdiagram.BackgroundAnnotationConfig;i="opacity lineWidth borderColor fillColor lineType zOrderType".split(" ");a=0;for(d=i.length;a<d;a+=1)j=i[a],g[j]=k.hasOwnProperty(j)?k[j]:h[j];switch(g.zOrderType){case 2:a=8;break;case 1:a=1;break;default:a=1}a=this.graphics.activate("placeholder",a);e=[];if(k.includeChildren){i=[];a=0;for(d=k.items.length;a<d;a+=1)h=k.items[a],h=this._treeItemsByUserId[h],null!=h&&
i.push(h);i=this._getAllLogicalChildren(i,"logicalChildren");a=0;for(d=i.length;a<d;a+=1)h=i[a],null!=h.orgItem&&e.push(h.orgItem.id)}else e=k.items;k=m.getMergedPerimeters(e);for(a=0;a<k.length;a+=1)g.draw(k[a])}}};
primitives.orgdiagram.BaseController.prototype._getBackgroundManager=function(){var a=new primitives.common.perimeter.Manager,b,c,d,e,f,g,h,i,j,k,l;if(0<this._treeLevels.length){i=[];f=[];b=0;for(c=this._treeLevels.length;b<c;b+=1)if(h=j=null,d=this._treeLevels[b],4!=d.actualVisibility){i.push(b);g=[];k=d.treeItems;d=0;for(e=k.length;d<e;d+=1)l=this._treeItems[k[d]],4!=l.actualVisibility&&null!=l.orgItem&&(null!=h&&this._addOffset(g,j,h,l),j=h,h=l);null!=h&&this._addOffset(g,j,h,null);f.push(g)}j=
[];g=[];b=0;for(c=f.length;b<c;b+=1)g=primitives.common.mergeSort([g,f[b]],null,!0),j.push(g),g=f[b];j.push(primitives.common.mergeSort([f[b-1]],null,!0));f=[];b=0;for(c=j.length;b<c;b+=1){h={};g=j[b];d=0;for(e=g.length;d<e;d+=1)k=g[d],h[k]=d;f.push(h)}h=[];d=g=null;b=0;for(c=i.length;b<c;b+=1)e=this._treeLevels[i[b]],null!=d&&this._addTreeLevelPerimeters(h,b-1,f,j,g,d,e),g=d,d=e;null!=d&&this._addTreeLevelPerimeters(h,b-1,f,j,g,d,null);a.add(h)}return a};
primitives.orgdiagram.BaseController.prototype._addTreeLevelPerimeters=function(a,b,c,d,e,f,g){var h=Math.floor(this.options.normalItemsInterval/2),e=null!=e?Math.floor(3*(e.shift+e.depth)/7+4*f.shift/7):f.shift-h,g=null!=g?Math.floor(3*(f.shift+f.depth)/7+4*g.shift/7):f.shift+f.depth+h,i=h=null,j=f.treeItems,k,l;k=0;for(l=j.length;k<l;k+=1)f=this._treeItems[j[k]],4!=f.actualVisibility&&null!=f.orgItem&&(null!=i&&this._addPerimeter(a,c[b],c[b+1],d[b],d[b+1],e,g,h,i,f),h=i,i=f);null!=i&&this._addPerimeter(a,
c[b],c[b+1],d[b],d[b+1],e,g,h,i,null)};primitives.orgdiagram.BaseController.prototype._addOffset=function(a,b,c,d){var e=Math.floor(this.options.normalItemsInterval/2),d=null!=d?Math.floor(3*(c.offset+c.actualSize.width)/7+4*d.offset/7):c.offset+c.actualSize.width+e;a.push(null!=b?Math.floor(3*(b.offset+b.actualSize.width)/7+4*c.offset/7):c.offset-e);a.push(d)};
primitives.orgdiagram.BaseController.prototype._addPerimeter=function(a,b,c,d,e,f,g,h,i,j){var k=[],l=primitives.common.perimeter.SegmentItem,m=Math.floor(this.options.normalItemsInterval/2),h=null!=h?Math.floor(3*(h.offset+h.actualSize.width)/7+4*i.offset/7):i.offset-m,j=null!=j?Math.floor(3*(i.offset+i.actualSize.width)/7+4*j.offset/7):i.offset+i.actualSize.width+m;k.push(new l(h,f,h,g));for(m=c[h]+1;m<=c[j];m+=1)k.push(new l(e[m-1],g,e[m],g));k.push(new l(j,g,j,f));for(m=b[j]-1;m>=b[h];m-=1)k.push(new l(d[m+
1],f,d[m],f));a.push(new primitives.common.perimeter.Item(i.orgItem.id,k))};
primitives.orgdiagram.BaseController.prototype._redrawConnectors=function(){var a=this.graphics.activate("placeholder",2),b,c,d,e,f,g,h,i;if(this._treeItems.hasOwnProperty(this._visualRootItem)){e=new primitives.common.PaletteManager(this.options);f=new primitives.common.PolylinesBuffer;for(i=0;i<this._treeLevels.length;i+=1){d=this._treeLevels[i];c=d.treeItems;g=0;for(h=c.length;g<h;g+=1)b=this._treeItems[c[g]],this._redrawConnector(a.hasGraphics,f,e,b,d)}this.graphics.polylinesBuffer(f)}};
primitives.orgdiagram.BaseController.prototype._redrawConnector=function(a,b,c,d,e){var f=this,g,h,i,j,k,l,m,n,p,q,r,t,v=0,s,w=0==this.options.connectorType,u;t=0<d.partnerConnectorOffset?e.shift+e.connectorShift-e.levelSpace/2*(e.partnerConnectorOffset-d.partnerConnectorOffset+1):d.connectorPlacement&4?d.actualPosition.bottom():e.shift+e.connectorShift;1>=d.partnerConnectorOffset?c.selectPalette(0):1<d.partnerConnectorOffset?c.selectPalette(d.partnerConnectorOffset-1):c.selectPalette(e.partnerConnectorOffset);
0<d.visualChildren.length&&(g=4===d.actualVisibility&&d.id===this._visualRootItem,r=d.actualPosition.horizontalCenter());i=[];if(1<d.partners.length||0<d.extraPartners.length){j=d.partners;for(m=0;m<j.length;m+=1)k=this._treeItems[j[m]],s=new primitives.orgdiagram.ConnectorPoint(k.actualPosition.horizontalCenter(),k.actualPosition.bottom()),s.isSquared=!0,s.highlightPath=k.partnerHighlightPath,s.connectorStyleType=k.partnerHighlightPath?2:1,s.visibility=k.actualVisibility,i.push(s);j=d.extraPartners;
for(m=0;m<j.length;m+=1)k=this._treeItems[j[m]],s=new primitives.orgdiagram.ConnectorPoint(k.actualPosition.horizontalCenter(),k.actualPosition.bottom()),s.isSquared=!0,s.highlightPath=k.partnerHighlightPath,s.connectorStyleType=k.partnerHighlightPath?2:0,s.visibility=k.actualVisibility,i.push(s);0<i.length&&(i.sort(function(a,b){return a.x-b.x}),0==d.visualChildren.length&&(r=(i[0].x+i[i.length-1].x)/2),b.addInverted(function(b){f._drawTopConnectors(b,c,r,t,i,!0,a,1==f.options.arrowsDirection)}))}h=
[];if(0<d.visualChildren.length){q=!1;j=d.visualChildren;for(m=0;m<j.length;m+=1)if(k=this._treeItems[j[m]],l=this._treeLevels[k.level],s=c.getPalette(k.highlightPath?2:1),u=b.getPolyline(s),k.connectorPlacement&8)n=this._treeItems[l.treeItems[k.levelPosition-1]],this.transform.transformPoints(k.actualPosition.x,k.actualPosition.verticalCenter(),n.actualPosition.right(),k.actualPosition.verticalCenter(),!0,this,function(a,c,d,e){f._drawLineWithArrow(a,c,d,e,b,u,k.actualVisibility,n.actualVisibility)});
else if(k.connectorPlacement&2)p=this._treeItems[l.treeItems[k.levelPosition+1]],this.transform.transformPoints(k.actualPosition.right(),k.actualPosition.verticalCenter(),p.actualPosition.x,k.actualPosition.verticalCenter(),!0,this,function(a,c,d,e){f._drawLineWithArrow(a,c,d,e,b,u,k.actualVisibility,p.actualVisibility)});else if(k.connectorPlacement&1&&!g){l=!0;if(a)switch(k.actualVisibility){case 2:case 3:l=w}s=new primitives.orgdiagram.ConnectorPoint(k.actualPosition.horizontalCenter()+0,k.actualPosition.top());
s.isSquared=l;s.connectorStyleType=k.highlightPath?2:1;s.visibility=k.actualVisibility;h.push(s);v=Math.max(v,s.connectorStyleType);q=q||s.isSquared}!g&&0<h.length&&(this.transform.transformPoints(r,t,r,e.shift+e.connectorShift,!0,this,function(a,e,g,j){var k=Math.round(f.options.elbowDotSize/2),l=c.getPalette(v),m=b.getPolyline(l),m=b.getPolyline(m.arrowPaletteItem);this.showElbowDots&&(0!=this.options.elbowType&&0<d.partners.length)&&m.segments.push(new primitives.common.DotSegment(a-k,e-k,2*k,
2*k,k));b.addInverted(function(c){c=c.getPolyline(l);c.segments.push(new primitives.common.MoveSegment(g,j));c.segments.push(new primitives.common.LineSegment(a,e));1==f.options.arrowsDirection&&(4!=d.visibility&&1>=i.length)&&c.addArrow(f.options.linesWidth,function(a,c){var d=b.getPolyline(c);d.segments=d.segments.concat(a)})});this.showElbowDots&&(0!=this.options.elbowType&&1<h.length)&&m.segments.push(new primitives.common.DotSegment(g-k,j-k,2*k,2*k,k))}),this._drawTopConnectors(b,c,r,e.shift+
...
primitives.orgdiagram.BaseController.prototype._drawTopConnectors=function(a,b,c,d,e,f,g,h){var i=this,j,k,l,m=[],n,p,q;if(f){m=[];f=0;for(k=e.length;f<k;f+=1)if(l=e[f],l.x<c&&!l.isSquared)m.push(l);else break;k=m.length;0<k&&this._drawAngularConnectors(a,b,c,d,m,!1,h);m=[];for(j=e.length-1;j>=f;j-=1)if(l=e[j],l.x>c&&!l.isSquared)m.push(l);else break;k=m.length;0<k&&this._drawAngularConnectors(a,b,c,d,m,!1,h);m={};k={};for(p in primitives.common.ConnectorStyleType)primitives.common.ConnectorStyleType.hasOwnProperty(p)&&
(m[primitives.common.ConnectorStyleType[p]]=c,k[primitives.common.ConnectorStyleType[p]]=c);for(p=f;p<=j;p+=1){l=e[p];n=b.getPalette(l.connectorStyleType);q=a.getPolyline(n);n=this.options.dotItemsInterval/2;2>n&&(n=0);if(g)switch(this.options.elbowType){case 2:case 3:0<n&&(Math.abs(c-l.x)>n&&Math.abs(d-l.y)>n)&&(l.hasElbow=!0,l.elbowPoint1=new primitives.common.Point(l.x,d+(d>l.y?-n:n)),l.elbowPoint2=new primitives.common.Point(l.x+(c>l.x?n:-n),d));break;case 1:0<j-f&&this.transform.transformPoints(l.x,
d,l.x,l.y,!0,this,function(b,c){var d=Math.round(i.options.elbowDotSize/2);a.getPolyline(q.arrowPaletteItem).segments.push(new primitives.common.DotSegment(b-d,c-d,2*d,2*d,d))})}m[l.connectorStyleType]=Math.min(m[l.connectorStyleType],l.hasElbow?l.elbowPoint2.x:l.x);k[l.connectorStyleType]=Math.max(k[l.connectorStyleType],l.hasElbow?l.elbowPoint2.x:l.x)}n=[Math.max(0,f-1),Math.min(j+1,e.length-1)];for(p=0;p<n.length;p+=1)l=e[n[p]],m[l.connectorStyleType]=Math.min(m[l.connectorStyleType],l.hasElbow?
l.elbowPoint2.x:l.x),k[l.connectorStyleType]=Math.max(k[l.connectorStyleType],l.hasElbow?l.elbowPoint2.x:l.x);l=c;for(p=2;0<=p;p-=1)n=b.getPalette(p),q=a.getPolyline(n),n=m[p],null!=n&&n<l&&(this.transform.transformPoints(l,d,n,d,!0,this,function(a,b,c,d){q.segments.push(new primitives.common.MoveSegment(a,b));q.segments.push(new primitives.common.LineSegment(c,d))}),l=n),n=k[p],null!=n&&n>c&&(this.transform.transformPoints(c,d,n,d,!0,this,function(a,b,c,d){q.segments.push(new primitives.common.MoveSegment(a,
b));q.segments.push(new primitives.common.LineSegment(c,d))}),c=n);for(p=f;p<=j;p+=1)l=e[p],n=b.getPalette(l.connectorStyleType),q=a.getPolyline(n),l.hasElbow?(this.transform.transform3Points(l.elbowPoint2.x,l.elbowPoint2.y,l.elbowPoint1.x,l.elbowPoint2.y,l.elbowPoint1.x,l.elbowPoint1.y,!0,this,function(a,b,c,d,e,f){switch(this.options.elbowType){case 2:q.segments.push(new primitives.common.MoveSegment(a,b));q.segments.push(new primitives.common.LineSegment(e,f));break;case 3:q.segments.push(new primitives.common.MoveSegment(a,
b)),q.segments.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}}),this.transform.transformPoints(l.elbowPoint1.x,l.elbowPoint1.y,l.x,l.y,!0,this,function(a,b,c,d){q.segments.push(new primitives.common.LineSegment(c,d))})):this.transform.transformPoints(l.x,d,l.x,l.y,!0,this,function(a,b,c,d){q.segments.push(new primitives.common.MoveSegment(a,b));q.segments.push(new primitives.common.LineSegment(c,d))}),g&&(h&&4!=l.visibility)&&q.addArrow(this.options.linesWidth,function(b,c){var d=a.getPolyline(c);
d.segments=d.segments.concat(b)})}else this._drawAngularConnectors(a,b,c,d,e,!0,h)};
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors=function(a,b,c,d,e,f,g){var h=null,i=e.length,j,k,l,m,h=f?c:e[i-1].x;k=new primitives.common.Point(h,d);for(c=0;c<i;c+=1){l=e[c];j=b.getPalette(l.connectorStyleType);m=a.getPolyline(j);this.transform.transformPoint(h,d,!0,this,function(a,b){m.segments.push(new primitives.common.MoveSegment(a,b))});switch(this.options.connectorType){case 1:this.transform.transformPoint(l.x,l.y,!0,this,function(a,b){m.segments.push(new primitives.common.LineSegment(a,
b))});break;case 2:j=new primitives.common.Rect(k,l),f?h>j.x?this.transform.transform3Points(j.right(),j.verticalCenter(),j.x,j.verticalCenter(),j.x,j.bottom(),!0,this,function(a,b,c,d,e,f){m.segments.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):this.transform.transform3Points(j.x,j.verticalCenter(),j.right(),j.verticalCenter(),j.right(),j.bottom(),!0,this,function(a,b,c,d,e,f){m.segments.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):h>j.x?this.transform.transformPoints(j.x,
j.y,j.x,j.bottom(),!0,this,function(a,b,c,d){m.segments.push(new primitives.common.QuadraticArcSegment(a,b,c,d))}):this.transform.transformPoints(j.right(),j.y,j.right(),j.bottom(),!0,this,function(a,b,c,d){m.segments.push(new primitives.common.QuadraticArcSegment(a,b,c,d))})}g&&4!=l.visibility&&m.addArrow(this.options.linesWidth,function(b,c,d){c=a.getPolyline(c);c.segments=c.segments.concat(b);this._debug&&(b=a.getPolyline({fillColor:"#ff0000"}),b.segments.push(new primitives.common.DotSegment(d.x-
...
primitives.orgdiagram.BaseController.prototype._setOffset=function(a){var b=this._treeLevels[a.level],c=this._itemsInterval[0===a.visibility?b.currentvisibility:a.visibility]/2,d,e,f,g,h,i;e=8*this.options.linesWidth;a.leftPadding=c+(0<b.currentOffset?c*a.relationDegree*this.options.cousinsIntervalMultiplier:0);a.rightPadding=c;0!=this.options.arrowsDirection&&(a.connectorPlacement&8&&(a.leftPadding+=e),a.connectorPlacement&2&&(a.rightPadding+=e));a.offset=b.currentOffset+a.leftPadding;b.currentOffset=
a.offset+a.actualSize.width+a.rightPadding;if(0<a.visualChildren.length){b=0;for(d=a.visualChildren.length;b<d;b+=1)this._setOffset(this._treeItems[a.visualChildren[b]]);c=this._getChildrenOffset(a);if(0<c)this._offsetItemChildren(a,c);else if(0>c&&(c=-c,this._offsetItem(a,c),d=null,e={},g=null,h=this._getParentItem(a),null!==h)){for(b=h.visualChildren.length-1;0<=b;b-=1)if(i=h.visualChildren[b],i===a)d=[];else if(null!==d)if(f=this._getGapBetweenSiblings(i,a),e[i.id]=f,0<f)d.splice(0,0,i);else{g=
i;break}if(0<d.length){if(null!==g){f=[g];f=f.concat(d);f.push(a);g=[[g]];b=1;for(d=f.length;b<d;b+=1)a=f[b-1],h=f[b],2==a.gravity||1==h.gravity?g[g.length-1].push(h):g.push([h])}else g=[d.slice(0)],g[g.length-1].push(a);if(0<g.length){d=g[g.length-1];for(b=d.length-2;0<=b;b-=1)a=d[b],f=e[a.id],c=Math.min(f,c),this._offsetItem(a,c),this._offsetItemChildren(a,c)}h=c/(g.length-1);for(d=g.length-2;0<d;d-=1){i=g[d];for(b=i.length-1;0<=b;b-=1)a=i[b],f=e[a.id],c=Math.min(d*h,Math.min(f,c)),this._offsetItem(a,
c),this._offsetItemChildren(a,c)}}}}};primitives.orgdiagram.BaseController.prototype._getGapBetweenSiblings=function(a,b){var c=null,d=this._getRightMargins(a),e=this._getLeftMargins(b),f=Math.min(d.length,e.length),g,h;for(g=0;g<f&&!(h=e[g]-d[g],c=null!==c?Math.min(c,h):h,0>=h);g+=1);return Math.floor(c)};
...
primitives.orgdiagram.BaseController.prototype._getNewTreeItem=function(a){var b=new primitives.orgdiagram.TreeItem(this._treeItemCounter),c;for(c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);this._treeItemCounter+=1;this._treeItems[b.id]=b;a=a.orgItem;null!=a&&(this._treeItemsByUserId[a.id]=b,c=this._templates[a.templateName],b.template=void 0!==c?c:this._defaultTemplate,b.actualHasSelectorCheckbox=this._getSelectionVisibility(this.options.cursorItem==a.id,a.hasSelectorCheckbox,this.options.hasSelectorCheckbox),
b.actualHasButtons=(0<this.options.buttons.length||null!=b.template.buttons&&0<b.template.buttons.length)&&this._getSelectionVisibility(this.options.cursorItem==a.id,a.hasButtons,this.options.hasButtons),b.actualIsActive=a.isActive&&b.template.isActive);return b};
...
null!=a)switch(a.isSelected=!0,0===a.visibility&&(a.visibility=1),this.options.selectionPathMode){case 1:f=this._getAllLogicalParents([a]);d=0;for(a=f.length;d<a;d+=1)e=f[d],0===e.visibility&&(e.visibility=1)}};primitives.orgdiagram.BaseController.prototype._getAllLogicalChildren=function(a){return this._getAllLogicalParents(a,"logicalChildren")};
primitives.orgdiagram.BaseController.prototype._getAllLogicalParents=function(a,b){var c=[],d=[],e,f=[],g,h,i,j,k={},b=b||"logicalParents";i=0;for(j=a.length;i<j;i+=1)if(e=a[i],!k.hasOwnProperty(e.id)){k[e.id]=!0;c.push(e);for(d=d.concat(e[b]);0<d.length;){g=0;for(h=d.length;g<h;g+=1)e=this._treeItems[d[g]],c.push(e),f=f.concat(e[b]);d=f;f=[]}}return c};primitives.orgdiagram.BaseController.prototype._virtualShowCursorNeighbours=function(){};
primitives.orgdiagram.BaseController.prototype._getSelectionVisibility=function(a,b,c){var d=!1;switch(b){case 0:switch(c){case 0:d=a;break;case 1:d=!0;break;case 2:d=!1}break;case 1:d=!0;break;case 2:d=!1}return d};primitives.common.ReferenceItem=function(){this.key=this.name="";this.actualTargets=[];this.targets=[];this.processed=!1;this.isVisible=!0;this.level=0};primitives.common.SharedReferences=function(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)};
primitives.common.StackSegment=function(a,b,c){this.context=a;this.startIndex=b;this.endIndex=c};primitives.common.StackSegment.prototype.toString=function(){return"["+Math.round(this.startIndex)+" - "+Math.round(this.endIndex)+"]"};primitives.common.perimeter.LinkedHashItems=function(){this.segmentsHash={};this.nextKeys={};this.prevKeys={};this.endSegmentKey=this.startSegmentKey=null};
primitives.common.perimeter.LinkedHashItems.prototype.add=function(a,b){if(this.segmentsHash.hasOwnProperty(a))throw"Duplicate segments are not supported!";this.segmentsHash[a]=b;this.nextKeys[a]=null;null==this.endSegmentKey?(this.startSegmentKey=a,this.prevKeys[a]=null):(this.nextKeys[this.endSegmentKey]=a,this.prevKeys[a]=this.endSegmentKey);this.endSegmentKey=a};
primitives.common.perimeter.LinkedHashItems.prototype.unshift=function(a,b){if(this.segmentsHash.hasOwnProperty(a))throw"Duplicate segments are not supported!";this.segmentsHash[a]=b;this.prevKeys[a]=null;null==this.startSegmentKey?(this.endSegmentKey=a,this.nextKeys[a]=null):(this.prevKeys[this.startSegmentKey]=a,this.nextKeys[a]=this.startSegmentKey);this.startSegmentKey=a};
primitives.common.perimeter.LinkedHashItems.prototype.insertAfter=function(a,b,c){if(this.segmentsHash.hasOwnProperty(b))throw"Duplicate segments are not supported!";if(null==a)this.unshift(b,c);else{var d=this.nextKeys[a];null==d?this.add(b,c):(this.segmentsHash[b]=c,this.nextKeys[a]=b,this.nextKeys[b]=d,this.prevKeys[d]=b,this.prevKeys[b]=a)}};
primitives.common.perimeter.LinkedHashItems.prototype.remove=function(a){var b=this.prevKeys[a],c=this.nextKeys[a];null!=b?this.nextKeys[b]=c:this.startSegmentKey=c;null!=c?this.prevKeys[c]=b:this.endSegmentKey=b;delete this.segmentsHash[a];delete this.nextKeys[a];delete this.prevKeys[a]};primitives.common.perimeter.LinkedHashItems.prototype.empty=function(){this.segmentsHash={};this.nextKeys={};this.prevKeys={};this.endSegmentKey=this.startSegmentKey=null};
primitives.common.perimeter.LinkedHashItems.prototype.iterate=function(a,b,c){this._iterate(!0,a,b,c)};primitives.common.perimeter.LinkedHashItems.prototype.iterateBack=function(a,b,c){this._iterate(!1,a,b,c)};primitives.common.perimeter.LinkedHashItems.prototype._iterate=function(a,b,c,d){var e;null==c&&(c=a?this.startSegmentKey:this.endSegmentKey);if(null!=b)for(;null!=c;)e=this.segmentsHash[c],null!=e&&b(e),c=c==d?null:a?this.nextKeys[c]:this.prevKeys[c]};
primitives.common.perimeter.LinkedHashItems.prototype.toArray=function(){var a=[];this.iterate(function(b){a.push(b)});return a};primitives.common.perimeter.Item=function(a,b){var c,d,e;this.id=a;this.segments=new primitives.common.perimeter.LinkedHashItems;if(null!=b){c=0;for(d=b.length;c<d;c+=1)e=b[c],this.segments.add(e.key,e)}};primitives.common.perimeter.Manager=function(a){this.perimetersHash={};this.perimetersBySegmentKey={};null!=a&&this.add(a)};
primitives.common.perimeter.Manager.prototype.add=function(a){var b=this,c,d,e;c=0;for(d=a.length;c<d;c+=1)e=a[c],this.perimetersHash[e.id]=e,e.segments.iterate(function(a){b.perimetersBySegmentKey[a.key]=e})};
primitives.common.perimeter.Manager.prototype.getMergedPerimeters=function(a){var b=[],c={},d,e,f,g,h,i;d=0;for(e=a.length;d<e;d+=1)f=a[d],c[f]=!this.perimetersHash.hasOwnProperty(f);d=0;for(e=a.length;d<e;d+=1)if(f=a[d],!c[f]){c[f]=!0;g=new primitives.common.perimeter.Item(f);f=this.perimetersHash[f];f.segments.iterate(function(a){g.segments.add(a.key,a)});b.push(g);for(h=g.segments.startSegmentKey;null!=h;)i=g.segments.segmentsHash[h],this.perimetersBySegmentKey.hasOwnProperty(i.oppositeKey)&&(f=
this.perimetersBySegmentKey[i.oppositeKey],c.hasOwnProperty(f.id)&&!c[f.id]&&(c[f.id]=!0,f.segments.iterateBack(function(a){a.key!=i.oppositeKey&&g.segments.insertAfter(h,a.key,a)},i.oppositeKey,null),f.segments.iterateBack(function(a){g.segments.insertAfter(h,a.key,a)},null,i.oppositeKey))),h=this._moveCursor(g.segments,i)}return b};
primitives.common.perimeter.Manager.prototype._moveCursor=function(a,b){for(var c=a.nextKeys[b.key],d;null!=b&&b.oppositeKey==(d=c||a.startSegmentKey);)null!=c&&(c=a.nextKeys[c]),a.remove(b.key),a.remove(d),b=a.segmentsHash[null!=c?a.prevKeys[c]:a.endSegmentKey];return c};
...
2:this.fromPoint.x>this.toPoint.x?0:1};primitives.common.getGraphSpanningTree=function(a,b,c){var d={},e={},f,g=[],h={},i,j,k,l,m,n,p;e[b]=!0;i=1;for(h[b]=null;0<i;){g=[];l=k=j=null;for(f in e)if(e.hasOwnProperty(f)){m=a[f];b=!1;for(n in m)if(m.hasOwnProperty(n)&&!h.hasOwnProperty(n)&&(p=m[n],b=!0,!k||0<=c(p,k)))j=n,k=p,l=f;b||g.push(f)}if(null==j)break;else e[j]=!0,i+=1,h[j]=l,d.hasOwnProperty(l)||(d[l]=[]),d[l].push(j);b=0;for(j=g.length;b<j;b+=1)delete e[g[b]],i-=1}return d};
primitives.common.getShortestPath=function(a,b,c,d){var e={},f={},g={},h,i,j,k,l;e[b]=!0;h=1;for(f[b]=0;0<h;){i=b=null;for(j in e)e.hasOwnProperty(j)&&(null==i?(b=j,i=f[j]):i>f[j]&&(b=j,i=f[j]));k=a[b];for(j in k)k.hasOwnProperty(j)&&(l=i+(null!=d?d(k[j]):1),f.hasOwnProperty(j)?f[j]>l&&e.hasOwnProperty(j)&&(f[j]=l,g[j]=b):(f[j]=l,g[j]=b,e[j]=!0,h+=1));if(b==c)break;else delete e[b],h-=1}for(a=[];null!=c;)a.push(c),c=g[c];return a};
...
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,i,j,k,l,m,n,p,q;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];j=d.length;k=e.length;i=h=0;p=m=n=l=null;0<j&&(l=d[h],n=!b?l:b(l));0<k&&(m=e[i],p=!b?m:b(m));for(q=null;h<j||i<k;)if(h>=j){if(!c||q!=m)f.push(m),q=m;i+=1;i<k&&(m=e[i],p=!b?m:b(m))}else if(i>=k){if(!c||q!=l)f.push(l),q=l;h+=1;h<j&&(l=d[h],n=!b?l:b(l))}else if(n<p){if(!c||q!=l)f.push(l),q=l;h+=1;h<j&&(l=d[h],n=!b?l:b(l))}else{if(!c||q!=m)f.push(m),
q=m;i+=1;i<k&&(m=e[i],p=!b?m:b(m))}d=f}}return d};
primitives.common.stackSegments=function(a,b){var c=0,d,e,f,g,h,i,j,k=[],l,m,n,p,q,r,t={};a.sort(function(a,b){return a.endIndex-a.startIndex-(b.endIndex-b.startIndex)});g=0;for(h=a.length;g<h;g+=1){f=a[g];e=d=0;n=f.startIndex;t[n]=d+1;p=f.endIndex;t[p]=e;j=k.length;if(0<j){l=[];r=q=!1;for(i=0;i<j;i+=1)m=k[i],m<n?(l.push(m),d=t[m],e=t[m]):m<p?(q||(l.push(n),q=!0),d=Math.max(d,t[m]),e=t[m]):(q||(l.push(n),q=!0),r||(l.push(p),r=!0,t[n]=d+1,t[p]=e),l.push(m));q||(l.push(n),q=!0);r||(l.push(p),r=!0,t[n]=
d+1,t[p]=e);k=l}else k=[n,p];b(f,t[n]);c=Math.max(c,t[n])}return c};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,i;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),i=a[g],d=b(i),0<=d)c=i;else{d=Math.abs(d);e>d&&(e=d,c=i);for(;f+1<g;)if(h=Math.round((f+g)/2),i=a[h],d=b(i),0==d){c=i;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=i)}return c};
...
primitives.famdiagram.Config=function(a){this.name=void 0!==a?a:"FamDiagram";this.classPrefix="famdiagram";this.graphicsType=0;this.actualGraphicsType=null;this.pageFitMode=3;this.minimalVisibility=2;this.orientationType=0;this.verticalAlignment=1;this.arrowsDirection=0;this.elbowType=3;this.elbowDotSize=4;this.emptyDiagramMessage="Diagram is empty.";this.items=[];this.annotations=[];this.highligtItem=this.cursorItem=null;this.selectedItems=[];this.hasSelectorCheckbox=0;this.selectCheckBoxLabel="Selected";
this.selectionPathMode=1;this.templates=[];this.defaulLabelAnnotationTemplate=this.defaultTemplateName=null;this.hasButtons=0;this.buttons=[];this.onCursorRender=this.onHighlightRender=this.onItemRender=this.onMouseClick=this.onButtonClick=this.onSelectionChanged=this.onSelectionChanging=this.onCursorChanged=this.onCursorChanging=this.onHighlightChanged=this.onHighlightChanging=null;this.dotLevelShift=this.normalLevelShift=20;this.normalItemsInterval=this.lineLevelShift=10;this.dotItemsInterval=1;
this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#000080";this.linesColor="#c0c0c0";this.linesWidth=1;this.linesType=0;this.linesPalette=[];this.showCallout=!0;this.defaultCalloutTemplateName=null;this.calloutfillColor="#000000";this.calloutBorderColor=null;this.calloutCornerRadius=this.calloutOffset=4;this.calloutPointerWidth="10%";this.calloutLineWidth=1;this.calloutOpacity=0.2;this.buttonsPanelSize=28;this.checkBoxPanelSize=
this.groupTitlePanelSize=24;this.distance=3;this.minimumScale=0.5;this.maximumScale=1;this.showLabels=0;this.labelSize=new primitives.common.Size(80,24);this.labelOffset=1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight="normal";this.enablePanning=!0;this.printPreviewPageSize=new primitives.common.Size(612,792)};
...
primitives.famdiagram.Controller.prototype._virtualCreateOrgTree=function(){var a,b,c,d,e,f,g,h={},i,j,k,l=[],m,n,p,q,r=this,t,v,s,w,u,x;this._defaultLabelAnnotationTemplateName=this.widgetEventPrefix+"DefaultLabelAnnotationTemplate";primitives.common.isNullOrEmpty(this.options.defaulLabelAnnotationTemplate)||(this._defaultLabelAnnotationTemplateName=this.options.defaulLabelAnnotationTemplate);this.showElbowDots=this.showInvisibleSubTrees=!0;this._treeItemConfigs={};this._famItems={};this._famItemsNonExtracted=
{};this.itemByChildrenKey={};this._orgPartners={};this._families=[];this._orgItems={};this._orgItemChildren={};this._orgItemRoot=null;this.maximumFamItemId=0;this.maximumLevel=this.minimumLevel=null;if(0<this.options.items.length){a=0;for(b=this.options.items.length;a<b;a+=1)c=this.options.items[a],null!=c&&(this._treeItemConfigs[c.id]=c,d=new primitives.famdiagram.FamilyItem({id:c.id,itemConfig:c,isActive:c.hasOwnProperty("isActive")?c.isActive:!0}),this._famItems[d.id]=d,c=parseInt(c.id,10),this.maximumFamItemId=
Math.max(isNaN(c)?0:c,this.maximumFamItemId));l={};p={};v=[];for(m in this._famItems)if(this._famItems.hasOwnProperty(m)){d=this._famItems[m];q={};f=d.itemConfig.parents;if(null!=f){a=0;for(b=f.length;a<b;a+=1)k=f[a],this._famItems.hasOwnProperty(k)&&(k!=d.id&&!q.hasOwnProperty(k))&&(q[k]=!0,e=this._famItems[k],e.children.push(d.id),e.logicalChildren.push(d.id),d.logicalParents.push(k),d.parents.push(k),l.hasOwnProperty(k)||(l[k]={}),l[k][m]=k,p.hasOwnProperty(m)||(p[m]={}),p[m][k]=m)}e=d.itemConfig.spouses;
null!=e&&0<e.length&&v.push(d)}a=0;for(b=v.length;a<b;a+=1){s=v[a];q={};q[s.id]=!0;w=[s.id];e=s.itemConfig.spouses;c=0;for(d=e.length;c<d;c+=1)f=e[c],this._famItems.hasOwnProperty(f)&&!q.hasOwnProperty(f)&&(q[f]=!0,w.push(f));u=!1;e=0;for(f=s.logicalChildren.length;e<f;e+=1)if(c=this._famItems[s.logicalChildren[e]],c.logicalParents.length==w.length){x=!0;d=0;for(g=c.logicalParents.length;d<g;d+=1)if(!q.hasOwnProperty(c.logicalParents[d])){x=!1;break}if(x){u=!0;break}}if(!u){this.maximumFamItemId+=
1;q=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:!1,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0});this._famItems[q.id]=q;c=0;for(d=w.length;c<d;c+=1)f=w[c],e=this._famItems[f],e.logicalChildren.push(q.id),e.children.push(q.id),q.logicalParents.push(e.id),q.parents.push(e.id),l.hasOwnProperty(e.id)||(l[e.id]={}),l[e.id][q.id]=e.id,p.hasOwnProperty(q.id)||(p[q.id]={}),p[q.id][e.id]=q.id}}this._sortItemsBylevelsTopo(this._famItems);for(n in this._famItems)this._famItems.hasOwnProperty(n)&&
(d=this._famItems[n],d.logicalChildren.sort(function(a,b){return r._famItems[a].level-r._famItems[b].level}),d.logicalParents.sort(function(a,b){return r._famItems[b].level-r._famItems[a].level}));for(n in this._famItems)this._famItems.hasOwnProperty(n)&&(this._famItems[n].level=null);this._sortItemsBylevelsSmart(this._famItems);if(0<this.options.annotations.length){for(n in this._famItems)this._famItems.hasOwnProperty(n)&&(d=this._famItems[n],d.logicalChildren.length=0,d.logicalParents.length=0,
d.children.length=0,d.parents.length=0);c={};a=0;for(b=this.options.annotations.length;a<b;a+=1)t=this.options.annotations[a],3==t.annotationType&&(c.hasOwnProperty(t.fromItem)?c[t.fromItem].push(t):c[t.fromItem]=[t]);for(i in c)if(c.hasOwnProperty(i)){b=c[i];b.sort(function(a,b){return b.toItems.length-a.toItems.length});for(a=0;a<b.length;a+=1)t=b[a],this._addLabelAnnotation(l,t.fromItem,t.toItems,function(){var a=null;r.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:r.maximumFamItemId,
isVisible:!0,isActive:!1,itemConfig:t,levelGravity:1});r._famItems[a.id]=a;return a.id}),this._addLabelAnnotation(p,t.fromItem,t.toItems,function(){var a=null;r.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:r.maximumFamItemId,isVisible:!0,isActive:!1,itemConfig:t,levelGravity:2});r._famItems[a.id]=a;return a.id})}for(m in this._famItems)if(this._famItems.hasOwnProperty(m)){d=this._famItems[m];i=l[d.id];if(null!=i)for(j in i)i.hasOwnProperty(j)&&(e=d,i[j]!=d.id&&(e=this._famItems[i[j]]),
c=this._famItems[j],p.hasOwnProperty(j)&&p[j].hasOwnProperty(d.id)&&p[j][d.id]!=j&&(c=this._famItems[p[j][d.id]]),e.logicalChildren.push(c.id),c.logicalParents.push(e.id),e.children.push(c.id),c.parents.push(e.id));f=p[d.id];if(null!=f)for(k in f)f.hasOwnProperty(k)&&(e=this._famItems[k],c=d,f[k]==d.id&&!l.hasOwnProperty(k)&&(e.logicalChildren.push(c.id),c.logicalParents.push(e.id),e.children.push(c.id),c.parents.push(e.id)))}}a={};for(n in this._famItems)this._famItems.hasOwnProperty(n)&&(a[n]=this._famItems[n].logicalChildren.slice(0));
a=primitives.common.optimizeReferences(a,function(){var a;r.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:r.maximumFamItemId,isVisible:!1,isActive:!1,levelGravity:2});r._famItems[a.id]=a;return a.id});for(n in a)a.hasOwnProperty(n)&&(i=a[n],r._famItems[n].logicalChildren=i);this._eliminateManyToMany(this._famItems,function(){r.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:r.maximumFamItemId,isVisible:!1,isActive:!1,itemConfig:new primitives.famdiagram.ItemConfig({id:r.maximumFamItemId}),
levelGravity:2})});this._resortItemsBylevels(this._famItems);this._fillInItems(this._famItems,function(){r.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:r.maximumFamItemId,levelGravity:2,isVisible:!1,isActive:!1})});this._setLogicalParents(this._famItems);if(this._debug)for(n in this._famItems)if(this._famItems.hasOwnProperty(n)){d=this._famItems[n];i=d.logicalChildren;for(a=0;a<i.length;a+=1){b=i[a];b=this._famItems[b];if(0>b.logicalParents.indexOf(n))throw"Family tree is broken. Logical child does not reference logical parent.";
if(null===b.level||null===d.level||b.level!=d.level+1)throw"Family tree is broken. Children/Parents or levels mismatch!";}}this._famItemsNonExtracted={};for(n in this._famItems)this._famItems.hasOwnProperty(n)&&(this._famItemsNonExtracted[n]=this._famItems[n]);this.properties="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");this.defaultItemConfig=
new primitives.famdiagram.ItemConfig;a=null;for(b=0;null!=(a=this._findLargestRoot());)n=new primitives.famdiagram.Family(b),this._extractOrgChart(n,this._famItems[a]),this._families.push(n),b+=1;l=[];m={};if(0<this._families.length){a=0;for(b=this._families.length;a<b;a+=1){n=this._families[a];c=0;for(d=n.links.length;c<d;c+=1)i=n.links[c],j=this._famItems[i.fromItem].familyId,k=this._famItems[i.toItem].familyId,j!=k&&(h.hasOwnProperty(j)||(h[j]={}),h[j].hasOwnProperty(k)||(h[j][k]=0),h[j][k]+=1,
h.hasOwnProperty(k)||(h[k]={}),h[k].hasOwnProperty(j)||(h[k][j]=0),h[k][j]+=1),this._families[k].backLinks.push(new primitives.famdiagram.FamLink(i.toItem,i.fromItem))}for(;l.length<this._families.length;){a=0;for(b=this._families.length;a<b;a+=1)if(n=this._families[a],!m.hasOwnProperty(n.id))if(j=primitives.common.getGraphSpanningTree(h,n.id,function(a,b){return a-b}),j.hasOwnProperty(n.id)){this._countNumberOfSubFamilies(n.id,j);l.push(n.id);m[n.id]=!0;i=j[n.id];c=0;for(d=i.length;c<d;c+=1){n=this._getFamilyAndItsSubFamilies(i[c],
j);e=0;for(f=n.length;e<f;e+=1)k=n[e],l.push(k),m[k]=!0}}else l.push(n.id),m[n.id]=!0}}this.maximumFamItemId+=1;this._orgItemRoot=this._createOrgItem(this.maximumFamItemId,null,null,this.minimumLevel-1,null);this._orgItemRoot.hideParentConnection=!0;this._orgItemRoot.hideChildrenConnection=!0;this._orgItemRoot.title="internal root";this._orgItemRoot.isVisible=!1;this._orgItemRoot.isActive=!1;m={};a=0;for(b=l.length;a<b;a+=1){n=this._families[l[a]];j={};k=this._orgItemRoot;d=0;h=n.links.concat(n.backLinks);
for(c=0;c<h.length;c+=1)if(i=h[c],p=this._orgItems[i.toItem],i=this._orgItems[i.fromItem],!0==m[p.familyId]){for(i=n.items[0];p.level>=i.level;)p=this._orgItems[p.parent];j[p.id]=j.hasOwnProperty(p.id)?j[p.id]+1:1;d<j[p.id]&&(k=p,d=j[p.id])}this._attachFamilyToOrgChart(k,n);m[n.id]=!0}a=this._getExtraGravity();b=this._getGrandChildren();this._balanceChildrenForItem(a,b,this._orgItemRoot)}};
primitives.famdiagram.Controller.prototype._addLabelAnnotation=function(a,b,c,d){var e,f,g,h;if(a.hasOwnProperty(b)){b=a[b];e=!0;f=null;for(h=0;h<c.length;h+=1)if(g=c[h],b.hasOwnProperty(g))if(null==f)f=b[g];else{if(f!=b[g]){e=!1;break}}else{e=!1;break}if(e){d=d();a.hasOwnProperty(f)||(a[f]={});a[f][d]=f;for(h=0;h<c.length;h+=1)g=c[h],b[g]=d}}};
...
primitives.famdiagram.Controller.prototype._balanceChildrenForItem=function(a,b,c){var d,e,f,g,h,i,j,k,l,m,n,p=[c],q,r=[],t,v,s,w,u;for(c.childIndex=0;0<p.length;){c=0;for(j=p.length;c<j;c+=1)if(q=p[c],d={},e={},this._orgItemChildren.hasOwnProperty(q.id)){v=this._orgItemChildren[q.id];l=null;t=[];if(0<v.length){f=0;for(g=v.length;f<g;f+=1){k=v[f];null==l&&(l=k);e[k.id]={};if(a.hasOwnProperty(k.id))for(w in n=a[k.id],n)if(n.hasOwnProperty(w)){u=n[w];e[k.id][w]={};h=0;for(i=u.length;h<i;h+=1)m=u[h],
m=m.commonParent==q.id?m.toParent:this._orgItems[m.fromParent].childIndex<this._orgItems[m.toParent].childIndex?"__right__":"__left__",k.id!=m&&(d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(m)||(d[k.id][m]=0),d[k.id][m]+=1,null==e[k.id][w][m]&&(e[k.id][w][m]=0),e[k.id][w][m]+=1)}0<f&&(d.hasOwnProperty(l.id)||(d[l.id]={}),d[l.id].hasOwnProperty(k.id)||(d[l.id][k.id]=0),d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(l.id)||(d[k.id][l.id]=0))}if(null!=l){f=0;l=l.id;for(s in d)if(d.hasOwnProperty(s)){g=
d[s];h=0;for(m in g)g.hasOwnProperty(m)&&(h+=g[m]);h>f&&(l=s,f=h)}d=primitives.common.getGraphGrowthSequence(d,l,function(a){return a});l=this._balanceItems(d,"__left__","__right__",e,b);e=0;for(d=l.length;e<d;e+=1)f=this._orgItems[l[e]],f.childIndex=e,t.push(f)}if(this._debug&&!primitives.common.compareArrays(this._orgItemChildren[q.id],t,function(a){return a.id}))throw"Balancing of items is broken! Incoming vs. outgoing arrays of items mismatch.";this._orgItemChildren[q.id]=t}r=r.concat(v)}p=r;
r=[]}};
primitives.famdiagram.Controller.prototype._balanceItems=function(a,b,c,d,e){var f=[],g,h,i,j,k,l,m,n,p,q,r,t,v,s,w,u,x,z,A,y;h=new primitives.famdiagram.Slots;h.add(new primitives.famdiagram.Slot(b));h.add(new primitives.famdiagram.Slot(null));h.add(new primitives.famdiagram.Slot(c));i=0;h.loop(function(a){i+=1;a.position=i});for(g=0;g<a.length;g+=1)if(j=a[g],j!=b&&j!=c)for(x in p=n=m=l=k=null,h.loop(function(a){var b,c,f,g;if(null==a.itemId){s=e[j];v=t=r=q=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(s&&
null!=s[b]&&(q+=a.crossings[b]*s[b]),v+=a.crossings[b]);for(b in d[j])if(d[j].hasOwnProperty(b))for(c in f=d[j][b],f)f.hasOwnProperty(c)&&(g=h.getSlot(c),null!=g&&(g.position<a.position?(q+=(a.left[b]||0)-(g.left[b]||0),t+=Math.abs(g.balance+1)):(q+=(a.right[b]||0)-(g.right[b]||0),t+=Math.abs(g.balance-1)),r+=Math.abs(g.position-a.position)));if(null==l||l>q||l==q&&(m>r||m==r&&(n>t||n==t&&p>v)))l=q,k=a,m=r,n=t,p=v}}),w=k.clone(),u=k.clone(),u.itemId=j,h.insertBefore(k,w),h.insertBefore(k,u),i=u.position=
...
primitives.famdiagram.Controller.prototype._attachFamilyToOrgChart=function(a,b){var c,d=b.items[0],e=null,e=a;for(c=a.level+1;c<d.level;c+=1)this.maximumFamItemId+=1,e=this._createOrgItem(this.maximumFamItemId,e.id,null,c,null),e.title="shift",e.isVisible=!1,e.isActive=!1,e.hideParentConnection=!0,e.hideChildrenConnection=!0,b.items.push(e);d.parent=e.id;d.hideParentConnection=!0;this._adoptOrgItem(d)};
primitives.famdiagram.Controller.prototype._extractOrgChart=function(a,b){var c,d,e=[],f,g;c=this._createOrgItem(b.id,null,a.id,b.level,b.itemConfig);c.hideParentConnection=!0;c.isVisible=b.isVisible;c.isActive=b.isActive;a.items.push(c);delete this._famItemsNonExtracted[b.id];b.familyId=a.id;for(e=this._extractChildren(a,b);0<e.length;){f=[];c=0;for(d=e.length;c<d;c+=1)g=e[c],f=f.concat(this._extractChildren(a,g));e=f}};
...
primitives.famdiagram.Controller.prototype._sortItemsBylevelsSmart=function(a){var b={},c,d;for(c in a)a.hasOwnProperty(c)&&(d=a[c],null==d.level&&(d.level=0,this._sortItemBylevels(d,a,b)))};
...
for(c=b.length-1;0<=c;c-=1)if(g=b[c],g=a[g],2==g.levelGravity){d=null;e=0;for(f=g.logicalChildren.length;e<f;e+=1)h=g.logicalChildren[e],h=a[h],d=null==d?h.level-1:Math.min(h.level-1,d);g.level=!d?g.level:d}};
...
primitives.famdiagram.Controller.prototype._setLogicalParents=function(a){var b,c,d,e,f;for(b in this._famItems)this._famItems.hasOwnProperty(b)&&(e=this._famItems[b],e.logicalParents=[]);for(b in a)if(a.hasOwnProperty(b)){e=a[b];c=0;for(d=e.logicalChildren.length;c<d;c+=1)f=e.logicalChildren[c],a[f].logicalParents.push(b)}};
...
primitives.famdiagram.Controller.prototype._virtualShowCursorNeighbours=function(){var a,b,c,d,e,f,g;if(null!==this._cursorTreeItem&&(0===this._cursorTreeItem.visibility&&(this._cursorTreeItem.visibility=1),null!=this._cursorTreeItem.itemConfig)){e=this._famItems[this._cursorTreeItem.itemConfig.id];f=[];for(b=e.children.slice(0);0<b.length;){f=f.concat(b);d=[];for(a=0;a<b.length;a+=1)c=this._famItems[b[a]],g=this._orgItems[b[a]],g.isActive||(d=d.concat(c.children)),f=f.concat(c.parents);b=d}for(b=
e.parents.slice(0);0<b.length;){f=f.concat(b);d=[];for(a=0;a<b.length;a+=1)c=this._famItems[b[a]],g=this._orgItems[b[a]],g.isActive||(d=d.concat(c.parents)),f=f.concat(c.children);b=d}for(a=0;a<f.length;a+=1)b=this._treeItemsByUserId[f[a]],0===b.visibility&&(b.visibility=1)}};primitives.famdiagram.EdgeItem=function(a,b){this.child=this.parent=null;switch(arguments.length){case 2:this.parent=a,this.child=b}};primitives.famdiagram.EdgeItem.prototype.toString=function(){return this.parent+","+this.child};
primitives.famdiagram.ExtraGravity=function(a){this.toParent=this.fromParent=this.commonParent=null;this.level=a};primitives.famdiagram.Family=function(a){this.familyPriority=this.id=null;this.items=[];this.links=[];this.backLinks=[];1==arguments.length&&(this.id=a)};
primitives.famdiagram.FamilyItem=function(a){var b;this.itemConfig=this.familyId=this.id=null;this.isActive=this.isVisible=!0;this.parents=[];this.children=[];this.logicalChildren=[];this.logicalParents=[];this.level=null;this.levelGravity=0;this.hideChildrenConnection=this.hideParentConnection=!1;switch(arguments.length){case 1:for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};primitives.famdiagram.FamLink=function(a,b){this.fromItem=a;this.toItem=b};
...
primitives.orgdiagram.Controller.prototype._virtualCreateOrgTree=function(){var a,b,c,d,e,f,g,h,i,j,k;this._treeItemConfigs={};this._orgItems={};this._orgItemChildren={};this._orgItemRoot=null;if(null!=this.options.items&&0<this.options.items.length){h="title description image itemTitleColor groupTitle groupTitleColor isVisible isActive hasSelectorCheckbox hasButtons itemType adviserPlacementType childrenPlacementType templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");i=
new primitives.orgdiagram.ItemConfig;j=0;k=[];c=0;for(d=this.options.items.length;c<d;c+=1)if(b=this.options.items[c],null!=b.id){this._treeItemConfigs[b.id]=b;a=new primitives.orgdiagram.OrgItem;a.id=b.id;a.parent=b.parent;e=parseInt(b.id,10);j=Math.max(isNaN(e)?0:e,j);a.context=b;e=0;for(f=h.length;e<f;e+=1)g=h[e],a[g]=void 0!==b[g]?b[g]:i[g];this._orgItems[a.id]=a;this._orgItemChildren.hasOwnProperty(a.parent)?this._orgItemChildren[a.parent].push(a):this._orgItemChildren[a.parent]=[a];null==a.parent&&
(k.push(a),a.itemType=0)}j+=1;this._orgItemRoot=new primitives.orgdiagram.OrgItem;this._orgItemRoot.id=j;this._orgItemRoot.hideParentConnection=!0;this._orgItemRoot.hideChildrenConnection=!0;this._orgItemRoot.title="internal root";this._orgItemRoot.isVisible=!1;this._orgItems[this._orgItemRoot.id]=this._orgItemRoot;this._orgItemChildren[this._orgItemRoot.id]=k;this._hideRootConnectors([this._orgItemRoot])}};
primitives.orgdiagram.Controller.prototype._hideRootConnectors=function(a){for(var b,c,d,e,f,g,h,i,j;0<a.length;){b=[];c=0;for(d=a.length;c<d;c+=1)if(g=a[c],!g.isVisible&&this._orgItemChildren.hasOwnProperty(g.id)){h=this._orgItemChildren[g.id];j=!0;e=0;for(f=h.length;e<f;e+=1)if(i=h[e],0!=i.itemType){j=!1;break}if(j){g.hideChildrenConnection=!0;e=0;for(f=h.length;e<f;e+=1)i=h[e],i.hideParentConnection=!0,i.isVisible||b.push(i)}}a=b}};
primitives.orgdiagram.Controller.prototype._defineLogicalParent=function(a,b){var c={},d,e={},f={},g,h,i;if(!a.actualIsActive||4==a.visibility){for(i=0;i<a.logicalParents.length;i+=1)d=a.logicalParents[i],e[d]=!0;for(;!primitives.common.isEmptyObject(e);){for(h in e)if(e.hasOwnProperty(h))if(d=this._treeItems[h],!d.actualIsActive||4==d.visibility){g=d.logicalParents;for(i=0;i<g.length;i+=1)d=g[i],f[d]=!0}else c[d.id]=d;e=f;f={}}}primitives.common.isEmptyObject(c)&&(c[a.id]=a);for(h in c)if(c.hasOwnProperty(h)){d=
...
primitives.orgdiagram.Controller.prototype._virtualShowCursorNeighbours=function(){var a,b,c,d,e,f;if(null!==this._cursorTreeItem){0===this._cursorTreeItem.visibility&&(this._cursorTreeItem.visibility=1);for(a=0;a<this._cursorTreeItem.logicalChildren.length;a+=1)e=this._cursorTreeItem.logicalChildren[a],0===e.visibility&&(e.visibility=1);d=this._getAllLogicalParents([this._cursorTreeItem]);a=0;for(b=d.length;a<b;a+=1)c=d[a],0===c.visibility&&(c.visibility=1);a=0;for(b=this._cursorTreeItem.logicalParents.length;a<
b;a+=1){f=this._treeItems[this._cursorTreeItem.logicalParents[a]];c=0;for(d=f.logicalChildren.length;c<d;c+=1)e=f.logicalChildren[c],0===e.visibility&&(e.visibility=1)}}};primitives.orgdiagram.ConnectorPoint=function(){this.parent=primitives.common.Point.prototype;this.parent.constructor.apply(this,arguments);this.hasElbow=!1;this.visibility=this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;this.highlightPath=0;this.connectorStyleType=1};primitives.orgdiagram.ConnectorPoint.prototype=new primitives.common.Point;
primitives.orgdiagram.LevelVisibility=function(a,b){this.level=a;this.currentvisibility=b};
...
0;this.level=null;this.hideChildrenConnection=this.hideParentConnection=!1;this.childIndex=null};
