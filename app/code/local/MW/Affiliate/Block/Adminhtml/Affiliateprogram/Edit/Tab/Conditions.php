...
//    }
    ...
    protected function _prepareForm()
    {
		...
		$fieldset->addField('title1', 'label', array(
          ...
          'after_element_html' => '<div style="width: 500px; float:left;">'.Mage::helper('affiliate')->__('Note: To create individual cart item rule go to Affiliate Commission/Customer Discount tab.').'</div>',
        ));
