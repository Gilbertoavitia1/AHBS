<?php
class MW_Affiliate_Block_Adminhtml_Affiliatebinarycheck_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('affiliatebinary_check');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('*/*/exportbinarycheckCsv', Mage::helper('affiliate')->__('CSV'));
        $this->addExportType('*/*/exportbinarycheckXml', Mage::helper('affiliate')->__('XML'));
...
//        $this->getCollection()->getSelect()->where("main_table.customer_id in (?)",$customer_ids);
    ...
    {
        return $this->getUrl('*/*/editigualable', array('id' => $row->getId()));
    }
