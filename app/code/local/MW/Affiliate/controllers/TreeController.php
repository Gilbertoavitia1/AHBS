<?php
class MW_Affiliate_TreeController extends Mage_Core_Controller_Front_Action {
    ...
    public function renderAction() {
            echo $this->getLayout()
                  ->createBlock('affiliate/likebox')
                  ->setTemplate('mw_affiliate/customer/account/tree.phtml')
                  ->toHtml();
    }
