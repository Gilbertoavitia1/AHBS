<?php
class MW_Affiliate_Block_Adminhtml_Affiliatebinaryreportresidual_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('affiliatebinaryreport_residual');
